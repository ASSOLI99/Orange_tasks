...
function subtract(n) {
  ...
  */
  ...
  document.write(`${numberBetweenUs(5,10)} <br>`);
  ...
  */
  ...
  document.write(`${multiplication2(10,20)} <br>`);
  ...
  */
  ...
  document.write(`${repeatChar("school", "o")} <br>`);
